...
<h1>ARTICULOS DE FOTOGRAFIA AVANZADA</h1>
  ...
  <div className="article-list"> 
      ...
      <div className="article-card">
          <img src="/assets/images/article4.png" alt="Article 1" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2>Fotografía de Paisajes Nocturnos</h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article7.png" alt="Article 3" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2>Macro Fotografía de Insectos</h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article8.png" alt="Article 1" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2>Fotografía de Paisajes Nocturnos</h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article9.png" alt="Article 2" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2>Retratos de Alta Velocidad </h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article10.png" alt="Article 3" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2> Macro Fotografía de Insectos</h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article5.png" alt="Article 2" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2>Retratos de Alta Velocidad </h2>
          </Link>
      ...
      <div className="article-card">
          <img src="/assets/images/article6.png" alt="Article 3" />
          <div className="article-content">
          <Link to="/ArticleDetail">
          <h2> Macro Fotografía de Insectos</h2>
          </Link>
